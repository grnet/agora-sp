...
var ValueToCustomer = React.createClass({
           ...
           render: function () {
               return (
                   <div className={this.props.valueToCustomer == null || this.props.valueToCustomer.length < 0 ? 'collapse' : ''}>
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
var ServiceVersionWrapper = React.createClass({
        ...
        var RequestProcedures = React.createClass({
            ...
            render: function () {
                return (
                    <div className={this.props.requestProcedures == null || this.props.requestProcedures.length < 0 ? 'collapse' : ''}>
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
               ...
               return (
                   <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div className="wrapper">
                            <span className={this.state.url == null || this.state.url.length < 0 ? 'collapse' : ''} >URL: <a target="blank" href={this.state.url}>{this.state.url}</a></span><br/>
                            <span className={this.state.email == null || this.state.email.length < 0 ? 'collapse' : ''}>Email: {this.state.email}</span>
                        </div>
                   </div>
               )
           }
            ...
            render: function () {
                return (
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div className="wrapper">
                                <span>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias </span>
                            </div>
                        </div>
                )
            }
            ...
            render: function () {
                return (
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <h2>Risks</h2>
                            <div className="wrapper">
                                <span>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias exceptu</span>
                            </div>
                        </div>
                )
            }
...
componentWillUnmount: function(){
            ...
            render: function () {
                return (
                    <div className={this.state.serviceOptions.length == 0 ? 'collapse' : ''}>
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    ...
    render: function () {
        ...
        return (
                <a href={"#"+ this.props.data.name.split(' ').join('_')} id={this.props.data.name.split(' ').join('_')}   onClick={this.onServiceClick} > <div className="service-pick col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div className="service-tile col-lg-12 col-md-12 col-sm-12 col-xs-12 center-text-xs" id={this.props.data.name.split(' ').join('_')}>
                         <img src= {"http://snf-715140.vm.okeanos.grnet.gr/" + this.props.data.logo }  className="service-logo col-lg-1 col-md-1 col-sm-2 col-xs-2" id={this.props.data.name.split(' ').join('_')} />
                        <h3 className="col-lg-8 col-md-8 col-sm-8 col-xs-8 col-xs-offset-1" id={this.props.data.name.split(' ').join('_')}>{this.props.data.name}</h3>
                    </div>
                </div> </a>
        )
    }
...
var ServiceAreas = React.createClass({
    ...
    render: function () {
        ...
        return (
                <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <h2 className="area-header"><img width="40" src={"http://snf-715140.vm.okeanos.grnet.gr/static/img/logos/" + this.props.service_area_icon} /> <span >{this.props.service_area}</span> </h2>
                    <div className="wrapper">
