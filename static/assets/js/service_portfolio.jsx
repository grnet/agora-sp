var ServiceHeadline = React.createClass({
               ...
               return (
                   <div className="col-lg-12">
                       ...
                       <div className="wrapper col-lg-12  col-md-12 links">
                           <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 evenAttribute"> Usage policy link <a target="blank" href={this.props.data.usage_policy_link.related.href}>here</a> </div>
                           <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12 oddAttribute"> Users documentation link  <a target="blank" href={this.props.data.user_documentation_link.related.href}>here</a> </div>
            ...
            render: function () {
                return (
                        <div className="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div className="wrapper">
                                <span>{this.props.fundersForService}</span><br/>
                            </div>
                        </div>
                )
            }
            ...
            render: function () {
                return (
                        <div className="col-lg-12">
                            <h2>Competitors</h2>
                            <div className="wrapper">
                                <span>{this.props.competitors}</span><br/>
                            </div>
                        </div>
                )
            }
           ...
           render: function () {
               ...
               return (
                   <div className="options col-lg-12 col-md-12 col-sm-12 col-xs-12">
                       ...
                       <span className="col-lg-2 col-lg-offset-1 col-md-2 col-md-offset-1 col-sm-2 col-sm-offset-1">{this.props.data.pricing}</span>
                           </div>
                       </div>
                   </div>
               )
        ...
        var DependencyWrapper = React.createClass({
            ...
            render: function () {
                ...
                return (
                        <div className="options col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <img src= { this.props.data.service.logo}  className="col-lg-1 col-md-1 col-sm-1 col-xs-6 col-xs-offset-3 col-sm-offset-0" />
                            <div className="col-lg-11 col-md-11 col-sm-11 col-xs-12 center-text-xs">
            ...
            componentDidMount: function(){
                this.serverRequest = $.ajax({
                    ...
                    success: function(data){
                        ...
                        this.setState({ dependencies: data.data.dependencies
                            });
        ...
        var ComponentWrapper = React.createClass({
            ...
            render: function () {
                ...
                return (
                        <div className="options col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <img src= { this.props.data.component.logo }  className="col-lg-1 col-md-1 col-sm-1 col-xs-6 col-xs-offset-3 col-sm-offset-0" />
                            <div className="col-lg-11 col-md-11 col-sm-11 col-xs-12 center-text-xs">
                                <h3 className="col-lg-12 option-name">{this.props.data.component.name}</h3>
                                <div className="features col-xs-12">
                                    <p className="col-lg-9 col-md-9 col-sm-9 center-text-xs padding-left-0">Service version: {this.props.data.component.version}</p>
            ...
            componentDidMount: function(){
                this.serverRequest = $.ajax({
                    ...
                    success: function(data){
                        ...
                        this.setState({ service_components : data.data.service_components_list.service_components
                        });
        ...
        var source = "https://agora-dev.vi-seem.eu/api/v1/portfolio/services/" + service_name;
