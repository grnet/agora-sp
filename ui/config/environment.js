  ...
  var ENV = {
    ...
    APP: {
      ...
      eosc_portal: {
        ...
        show_actions_resource: true, // set to false to hide publish to eosc portal actions for resources
        show_actions_provider: true, // set to false to hide publish to eosc portal actions for providers
