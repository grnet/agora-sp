...
export default AgoraGen.extend({
  ...
  common: {
    validators: {
      ...
      erp_mgi_3_terms_of_use: [validate.format({ type: 'url', allowBlank: false }), httpValidator],
      erp_mgi_4_privacy_policy: [validate.format({ type: 'url', allowBlank: false }), httpValidator],
