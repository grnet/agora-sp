...
const provider = {
  ...
  'fields': {
    ...
    'epp_bai_0_id.required': 'EPP.BAI.0 - ID *',
    'epp_bai_1_name': 'EPP.BAI.1 - Name',
    'epp_bai_1_name.required': 'EPP.BAI.1 - Name *',
    'epp_bai_2_abbreviation': 'EPP.BAI.2 - Abbreviation',
    'epp_bai_2_abbreviation.required': 'EPP.BAI.2 - Abbreviation *',
  ...
  'hints': {
    'epp_bai_0_id': `${EOSC_HINT}<strong>Unique</strong> identifier of the provider`,
    'epp_bai_1_name': `${EOSC_HINT}<strong>Unique</strong> Full Name of the Provider offering the resource and acting as main contact point.`,
    'epp_bai_2_abbreviation': `${EOSC_HINT}Abbreviation or Short name of the Provider`,
    'epp_bai_3_website': `${EOSC_HINT}Website with information about the Provider.`,
    'epp_bai_4_legal_entity': `${EOSC_HINT}Is the provider a legal entity?`,
