...
export const eosc = {
  resource: {
    ...
    approve: {
      title: 'Approve Resource for EOSC Portal',
      label: 'Approve Resource for EOSC Portal',
      ok: 'Approve',
      message: `<div class="eosc-portal-modal"><img src="${ROOT_URL}assets/logo-eosc-portal.png" /><p>This action will approve the resource for <strong>${EOSC_PORTAL_API}</strong>.<p>Are you sure you want to continue?</p></div>`,
      error: 'The action could not be successfully performed',
      success: 'The resource has been successfully approved for EOSC Portal',
    },
    reject: {
      title: 'Delete Resource for EOSC Portal',
      label: 'Delete Resource for EOSC Portal',
      ok: 'Delete',
      message: `<div class="eosc-portal-modal"><img src="${ROOT_URL}assets/logo-eosc-portal.png" /><p>This action will delete the resource for <strong>${EOSC_PORTAL_API}</strong>.<p>Are you sure you want to continue?</p></div>`,
      error: 'The action could not be successfully performed',
      success: 'The resource has been successfully deleted for EOSC Portal',
    },
  },
  provider: {
    post: {
    ...
    reject: {
      title: 'Delete Provider for EOSC Portal',
      label: 'Delete Provider for EOSC Portal',
      ok: 'Delete',
      message: `<div class="eosc-portal-modal"><img src="${ROOT_URL}assets/logo-eosc-portal.png" /><p>This action will delete the provider for <strong>${EOSC_PORTAL_API}</strong> <p>Are you sure you want to continue?</p></div>`,
      error: 'The action could not be successfully performed',
      success: 'The provider has been successfully deleted for EOSC Portal',
    },
  },
};
