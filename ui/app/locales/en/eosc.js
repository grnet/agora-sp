...
export const eosc = {
  resource: {
    ...
    reject: {
      title: 'Reject Resource for EOSC Portal',
      label: 'Reject Resource for EOSC Portal',
      ok: 'Reject',
      message: `<div class="eosc-portal-modal"><img src="${ROOT_URL}assets/logo-eosc-portal.png" /><p>This action will reject the resource for <strong>${EOSC_PORTAL_API}</strong>.<p>Are you sure you want to continue?</p></div>`,
      error: 'The action could not be successfully performed',
      success: 'The resource has been successfully rejected for EOSC Portal',
    },
  },
  provider: {
    post: {
