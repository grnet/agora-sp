...
const resource = {
  ...
  fields: {
    ...
    'erp_bai_0_id.required': 'ERP.BAI.0 - ID *',
    erp_bai_1_name: 'ERP.BAI.1 - Name',
    'erp_bai_1_name.required': 'ERP.BAI.1 - Name *',
    erp_bai_2_service_organisation: 'ERP.BAI.2 - Resource Organisation',
    'erp_bai_2_service_organisation.required': 'ERP.BAI.2 - Resource Organisation *',
  ...
  hints: {
    ...
    erp_bai_1_name: `${EOSC_HINT}<strong>Unique</strong>, brief and descriptive name of Resource as assigned by the Provider.`,
    erp_bai_2_service_organisation: `${EOSC_HINT}The name (or abbreviation) of the organisation that manages or delivers the Resource, or that coordinates resource delivery in a federated scenario.`,
    ...
    erp_bai_4_webpage: `${EOSC_HINT}Webpage with information about the Resource usually hosted and maintained by the Provider.`,
    ...
    erp_mri_4_multimedia: 'List of links to video, screenshots or slides showing details of the Resource.',
    erp_mri_5_use_cases: 'List of links to use cases supported by this Resource.',
