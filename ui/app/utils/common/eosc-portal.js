...
function promptProvider(self, method) {
  ...
  const epp_loi_1_street_name_and_number = get(self, 'model.epp_loi_1_street_name_and_number');
  const epp_loi_2_postal_code = get(self, 'model.epp_loi_2_postal_code');
  const epp_loi_3_city = get(self, 'model.epp_loi_3_city');
  const epp_loi_5_country_or_territory = get(self, 'model.epp_loi_5_country_or_territory');
  ...
  if (!epp_bai_0_id) { missing.push('epp_bai_0_id') }
  if (!epp_bai_1_name) { missing.push('epp_bai_1_name') }
  if (!epp_bai_2_abbreviation) { missing.push('epp_bai_2_abbreviation') }
  if (!epp_bai_3_website) { missing.push('epp_bai_3_website') }
  if (!epp_bai_4_legal_entity) { missing.push('epp_bai_4_legal_entity') }
  if (!epp_loi_1_street_name_and_number) { missing.push('epp_loi_1_street_name_and_number') }
  if (!epp_loi_2_postal_code) { missing.push('epp_loi_2_postal_code') };
  if (!epp_loi_3_city) { missing.push('epp_loi_3_city')};
  if (!epp_loi_5_country_or_territory) { missing.push('epp_loi_5_country_or_territory')};
  if (!epp_mri_1_description) { missing.push('epp_mri_1_description')};
  if (!epp_mri_2_logo) { missing.push('epp_mri_2_logo')};
  if (!main_contact) { missing.push('main_contact')};
  if (!public_contact) { missing.push('public_contact')};
...
const postResourceEOSC = {
  ...
  hidden: computed(
    ...
    function(){
      ...
      if ( HIDE_ACTIONS_RESOURCE ) { return true }
