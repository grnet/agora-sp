...
urlpatterns = [
    ...
    url(r'^service_details_component/?$', views.service_details_component_write_ui),
    ...
    url(r'^service_details_component/(?P<serv_det_comp_uuid>[0-9a-zA-Z\-]+)/?$', views.service_details_component_edit_ui),
]