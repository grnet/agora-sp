...
class ComponentTestCase(TestCase):
    ...
    def test_get_service_components(self):
        ...
        expected_response = {"status": "200 OK", "info": "service components information", "data": [{"description": "Python/Django", "uuid": "3fa0bece-3e12-40ca-8345-1af82bf5f471", "name": "Application framework"}]}
        self.assertJSONEqual(json.dumps(expected_response), response.content)
    ...
    def test_get_service_component_implementations(self):
        ...
        expected_response = {"status": "200 OK", "info": "service component implementation information", "data": [{"description": "Some sample description", "uuid": "5e27aa64-4668-464c-96c7-fbe5b4871219", "name": "App framework"}]}
        self.assertJSONEqual(json.dumps(expected_response), response.content)
