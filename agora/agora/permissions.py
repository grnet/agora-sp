...
def get_rules():
    rules = [
        ...
        ('api/v2/custom-users', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/custom-users', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/resource-admins', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/resource-admins', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resource-admins', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resource-admins', 'create', 'portfolioadmin', '*', 'check_create_other', 'resource,admin', '*'),
        ...
        ('api/v2/resource-admins', 'partial_update', 'portfolioadmin', '*', 'check_update', 'state', '*'),
        ...
        ('api/v2/resource-admins', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/resource-admins', 'delete', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/contact-information', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/contact-information', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/contact-information', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/contact-information', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/contact-information', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/contact-information', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/contact-information', 'delete', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/providers', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/providers', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/providers', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/providers', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/providers', 'update', 'provideradmin', '*', 'update_organisation_owned', '*', '*'),
        ('api/v2/providers', 'partial_update', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/providers', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/providers', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/providers', 'delete', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resources', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resources', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resources', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resources', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resources', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resources', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/resources', 'delete', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/target-users', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/target-users', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/target-users', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/target-users', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/target-users', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/target-users', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/affiliations', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/affiliations', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/affiliations', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/affiliations', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/affiliations', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/affiliations', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/affiliations', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/affiliations', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/networks', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/networks', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/networks', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/networks', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/networks', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/networks', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/networks', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/networks', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/legalstatuses', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/legalstatuses', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/legalstatuses', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/legalstatuses', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/legalstatuses', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/legalstatuses', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/legalstatuses', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/legalstatuses', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/structures', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/structures', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/structures', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/structures', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/structures', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/structures', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/structures', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/structures', 'delete', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/esfridomains', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/esfridomains', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfridomains', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfridomains', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfridomains', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfridomains', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/esfritypes', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/esfritypes', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/esfritypes', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/esfritypes', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfritypes', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfritypes', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfritypes', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/esfritypes', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/activities', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/activities', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/activities', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/activities', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/activities', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/activities', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/activities', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/activities', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/order-types', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/order-types', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/order-types', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/order-types', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/order-types', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/order-types', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/order-types', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/order-types', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/access-types', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/access-types', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/access-types', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/access-types', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-types', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-types', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-types', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-types', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/access-modes', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/access-modes', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/access-modes', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/access-modes', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-modes', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-modes', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-modes', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/access-modes', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/trls', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'list', 'provideradmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'list', 'serviceadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'list', 'observer', '*', '*', '*', '*'),
        ('api/v2/trls', 'retrieve', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/trls', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/trls', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/resource-lifecycle-statuses', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/resource-lifecycle-statuses', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resource-lifecycle-statuses', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/resource-lifecycle-statuses', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/resource-lifecycle-statuses', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/resource-lifecycle-statuses', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/resource-lifecycle-statuses', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/resource-lifecycle-statuses', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/funding-bodies', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/funding-bodies', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/funding-bodies', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/funding-bodies', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-bodies', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-bodies', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-bodies', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-bodies', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/funding-programs', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/funding-programs', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/funding-programs', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/funding-programs', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-programs', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-programs', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-programs', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/funding-programs', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/challenges', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/challenges', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/challenges', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/challenges', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/challenges', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/challenges', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/challenges', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/challenges', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/domains', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/domains', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/domains', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/domains', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/domains', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/domains', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/domains', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/domains', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/subdomains', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/subdomains', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/subdomains', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/subdomains', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subdomains', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subdomains', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subdomains', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subdomains', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/supercategories', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/supercategories', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/supercategories', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/supercategories', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/supercategories', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/supercategories', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/supercategories', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/supercategories', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/subcategories', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/subcategories', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/subcategories', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/subcategories', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subcategories', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subcategories', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subcategories', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/subcategories', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/categories', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/categories', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/categories', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/categories', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/categories', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/categories', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/categories', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/categories', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/merildomains', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/merildomains', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/merildomains', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/merildomains', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merildomains', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merildomains', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merildomains', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merildomains', 'delete', 'portfolioadmin', '*', '*', '*', '*'),

        ('api/v2/merilsubdomains', 'list', 'superadmin', '*', '*', '*', '*'),
        ('api/v2/merilsubdomains', 'list', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/merilsubdomains', 'retrieve', 'portfolioadmin', '*', '*', '*', '*'),
        ...
        ('api/v2/merilsubdomains', 'create', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merilsubdomains', 'update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merilsubdomains', 'partial_update', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merilsubdomains', 'destroy', 'portfolioadmin', '*', '*', '*', '*'),
        ('api/v2/merilsubdomains', 'delete', 'portfolioadmin', '*', '*', '*', '*'),
