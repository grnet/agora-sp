...
RULES = [
    ...
    ('api/v2/custom-users', 'retrieve', 'serviceadmin', '*', '*', '*', '*'),
    ...
    ('api/v2/service-admins', 'list', 'serviceadmin', 'has_serviceadminship', '*', '*', '*'),
    ('api/v2/service-admins', 'list', 'observer', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'retrieve', 'superadmin', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'retrieve', 'admin', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'retrieve', 'serviceadmin', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'retrieve', 'observer', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'create', 'superadmin', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'create', 'admin', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'create', 'serviceadmin', '*', '*', 'service,admin', '*'),
    ('api/v2/service-admins', 'update', 'superadmin', '*', '*', '*', '*'),
    ('api/v2/service-admins', 'update', 'admin', '*', '*', '*', '*'),
